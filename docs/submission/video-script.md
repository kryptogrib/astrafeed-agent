...
- open [OKX.AI listing #13877](https://www.okx.ai/agents/13877) and say it is **submitted, pending review**. Do not say an agent can discover it in the marketplace;
...
| 0:20–0:45 | [okx.ai/agents/13877](https://www.okx.ai/agents/13877) (“under review”), then the public A2MCP URL. | AstraFeed is registered on OKX.AI as agent 13877. The listing is still in review, so agents call the public HTTPS endpoint directly. |
...
| 3:25–3:35 | GitHub `kryptogrib/astrafeed-agent` and listing 13877. | AstraFeed: a source-backed crypto Telegram agenda for AI agents. Listing 13877 is submitted and waiting for OKX review. |

Don't:

- call it market sentiment or trading advice;
- claim marketplace discovery, x402, or a paid tier;
